...
namespace AcessLayer.Firebase
{
    ...
    public class ABooksFirebase
    {
        ...
        {
            return (await AcessFirebase.firebase.Child("Books").OnceAsync<Book>())
                .Where(a => a.Object.Title == bookName && a.Object.UserKey == userKey)
                .Select(item => new Book { Key = item.Key, }).ToList().Count <= 0;
        }
        ...
        {
            return (await AcessFirebase.firebase.Child("Books").OnceAsync<Book>())
                .Where(a => a.Object.UserKey == vUserKey && a.Object.LastUpdate >= vLastUpdate)
        ...
        {
            Book toUpdateBookStatus = (await AcessFirebase.firebase.Child("Books").OnceAsync<Book>()).FirstOrDefault(a => a.Key == book.Key && a.Object.UserKey == book.UserKey).Object;
