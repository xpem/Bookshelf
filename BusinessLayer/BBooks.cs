...
namespace BusinessLayer
{
    public class BBooks
    {
        ...
        public async static Task<List<Books.Book>> GetBookSituationByStatus(int Situation, int index)
        {
            Users login = SqLiteUser.RecAcesso();
        ...
        public static async Task UpdateSituationBook(string vKey, int vSituation, int vRate, string vComment)
        {
            ...
            await AcessLayer.ABooks.UpdateSituationBook(vKey, login.Key, vSituation, vRate, vComment);
        }
